package com.company.jmixpmdata.view.customer;
...
public class CustomerListView extends StandardListView<Customer> {
    ...
    public void onInit(final InitEvent event) {
        customersDataGrid.getActions().forEach(action -> {
    ...
    @Subscribe("customersDataGrid.createAction")
    public void onCustomersDataGridCreateAction(final ActionPerformedEvent event) {
    ...
    @Subscribe("customersDataGrid.editAction")
    public void onCustomersDataGridEditAction(final ActionPerformedEvent event) {
        updateControls(true);
    }
    ...
    public void onCustomersDcItemChange(final InstanceContainer.ItemChangeEvent<Customer> event) {
        ...
        dataContext.clear();
        if (entity != null) {
            customerDl.setEntityId(EntityValues.getId(entity));
            customerDl.load();
        } else {
            customerDl.setEntityId(null);
    ...
    private OperationResult saveEditedEntity() {
        Customer item = customerDc.getItem();
    ...
    private ValidationErrors validateView(Customer entity) {
    ...
    private void updateControls(boolean editing) {
        ...
        customersDataGrid.getActions().forEach(Action::refreshState);
